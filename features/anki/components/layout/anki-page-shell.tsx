...
function Root({ children, className }: { children: ReactNode; className?: string }) {
  return (
    <main className="min-h-screen bg-linear-to-b from-background via-secondary/20 to-background">
      <div
        className={cn(
          "mx-auto flex max-w-7xl flex-col gap-6 px-5 pb-16 pt-8 sm:gap-8 sm:px-8 sm:pb-20 sm:pt-12 lg:px-10",
          className,
        )}
      >
        {children}
...
/**
 * Compound layout primitive for Anki pages.
 */
export const AnkiPageShell = {
  Actions,
  Body,
  Header,
  Root,
