        ...
        <CardContent className="flex flex-col gap-4 p-5 sm:p-8">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div className="flex max-w-2xl flex-col gap-2">
              ...
              <h2 id="preview-heading" className="font-heading text-xl text-foreground sm:text-3xl">
                Question review
              </h2>
          ...
          return (
            ...
            >
              <Card className="overflow-hidden rounded-[2rem] border-border/70 bg-card/90 shadow-sm transition-shadow hover:shadow-md">
                <CardHeader className="gap-3 border-b border-border/70 bg-secondary/35 p-5 pb-4 sm:p-6 sm:pb-4">
