...
export function LandingHero() {
  return (
    <section className="relative isolate overflow-hidden">
      ...
      <div className="mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-7xl flex-col justify-center px-6 py-16 sm:px-8 lg:px-10">
        <motion.div
        ...
        >
          <div className="flex flex-col gap-7">
            <div className="flex flex-wrap gap-3">
              <Badge variant="outline" className="h-auto rounded-full px-4 py-2 text-[0.7rem] uppercase tracking-[0.28em]">
                <Languages data-icon="inline-start" />
                English, made readable
              </Badge>
              <Badge variant="secondary" className="h-auto rounded-full px-4 py-2 text-[0.7rem] uppercase tracking-[0.28em]">
            ...
            <div className="flex max-w-3xl flex-col gap-5">
              ...
              <h1 className="font-heading text-5xl leading-none tracking-[-0.04em] text-balance sm:text-6xl lg:text-8xl">
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                ...
                className={cn(
                  ...
                  "rounded-full px-7 text-sm uppercase tracking-[0.22em]",
                )}
              >
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-border/70 bg-card/90 p-6 shadow-2xl shadow-primary/10">
              <div className="flex items-center justify-between border-b border-dashed border-border pb-4">
                <p className="text-xs uppercase tracking-[0.3em] text-muted-foreground">
                  Reading Desk
                </p>
                <p className="font-heading text-lg">Beginner to Advanced</p>
              </div>
              ...
              <div className="flex flex-col gap-5 py-6">
                {learningSignals.map((signal, index) => (
                  <motion.div
                    ...
                    className="flex items-start gap-4 rounded-3xl border border-border/60 bg-background/70 px-4 py-4"
                  >
                    <span className="font-heading text-3xl leading-none text-muted-foreground">
                      0{index + 1}
                    </span>
                    <p className="pt-1 text-sm leading-7 text-foreground/90">{signal}</p>
                  </motion.div>
                ))}
              </div>
              ...
              <div className="rounded-[1.5rem] border border-border/70 bg-secondary/70 p-5">
                ...
                <p className="mt-3 max-w-md font-heading text-2xl leading-tight tracking-[-0.03em]">
